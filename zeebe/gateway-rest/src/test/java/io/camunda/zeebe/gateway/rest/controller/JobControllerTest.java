...
import io.camunda.zeebe.gateway.rest.controller.JobControllerTest.TestJobApplication.ResettableJobActivationRequestResponseObserver;
...
public class JobControllerTest extends RestControllerTest {
  ...
  static class TestJobApplication {
    ...
    public ResponseObserverProvider responseObserverProvider(
        final JobActivationRequestResponseObserver responseObserver) {
    ...
    static class ResettableJobActivationRequestResponseObserver
        extends JobActivationRequestResponseObserver {
      public void reset() {
        response = new JobActivationResponse();
      }
    }
  }
}
